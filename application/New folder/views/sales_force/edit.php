...
<section class="content">
    ...
    <div class="box">
		...
		<form id="form-data1" action="<?php echo site_url('Sales_force/save_edit')?>" method="post" enctype="multipart/form-data" autocomplate="onload"> 
<?php
...
<table align ="left">
		<tr><td>Nama Lengkap </td>
			<td><input value="<?=$x->nama_lengkap;?>" name="nama_lengkap" type="text" onkeypress="return huruf(event)"></td>
		</tr>

		<tr><td>Nama Panggil </td>
			<td><input name="nama_panggil"type="text" value="<?=$x->nama_panggil;?>"onkeypress="return huruf(event)"></td>
		</tr>
		
		<tr><td>No KTP </td>
			<td><input name="no_ktp" value="<?=$x->no_ktp;?>" onkeypress="return hanyaAngka(event)" maxlength="16" type="text"></td>
		</tr>
		...
		<tr><td>Tempat Lahir </td>
			<td><input name="tempat_lahir" value="<?=$x->tempat_lahir;?>" type="text" onkeypress="return huruf(event)"></td>
		</tr>
		
		<tr><td>Tanggal Lahir </td>
			<td><input name="tanggal_lahir"  value="<?=$x->tanggal_lahir;?>" id="tanggal_lahir" size="40" type="date"></td>
		</tr>
		
		<tr><td>Tinggi Badan </td>
			<td><input style="width:50px;"  value="<?=$x->tinggi_badan;?>" name="tb" type="number" maxlength="3">cm</td>
		</tr>
		
		<tr><td>Berat Badan </td>
			<td><input style="width:50px;" name="bb"  value="<?=$x->berat_badan;?>" type="number" maxlength="3">kg</td>
		</tr>
		...
		<tr><td>Kota</td>
			<td><input name="kota" type="text"  value="<?=$x->kota;?>" onkeypress="return huruf(event)"></td>
		</tr>
		
		<tr><td>Kode Pos </td>
			<td><input name="kodepos"  value="<?=$x->kodepos;?>" onkeypress="return hanyaAngka(event)" maxlength="5" type="text"></td>
		</tr>
	
		<tr><td>Lama Tinggal </td>
			<td><input style="width:50px;"  value="<?=$x->lama;?>" name="lama" onkeypress="return hanyaAngka(event)" maxlength="3" type="text">Tahun</td>
		</tr>
	
		<tr><td>Status Tempat Tinggal </td>
		<td>
			<input name="status_tinggal" type="radio" value="orang tua" <? if($x->status_tinggal=='orang tua'){echo 'checked';}?> >orang tua 
...
<table align="center">	
		...
		<tr>
		<td>Telp Rumah </td>
		<td><input name="telp" type="text" maxlength="13"  value="<?=$x->telp;?>" onkeypress="return hanyaAngka(event)"></td>
		</tr>
		
		<tr>
		<td>No HP </td>
		<td><input name="hp"  type="text" maxlength="13"  value="<?=$x->hp;?>" onkeypress="return hanyaAngka(event)" ></td>
		</tr>
		
		<tr>
		<td>No HP 2 </td>
		<td><input name="hp2"  type="text" maxlength="13"  value="<?=$x->hp2;?>"  onkeypress="return hanyaAngka(event)" ></td>
		</tr>
		
		<tr>
		<td>Nama Ibu Kandung </td>
		<td><input name="ibu" type="text"  value="<?=$x->ibu;?>" onkeypress="return huruf(event)" ></td>
		</tr>
		
		<tr>
		<td>Alamat Rumah Tinggal KTP </td>
		<td><textarea name="alamat_ktp" type="text" /><?=$x->alamat_ktp;?></textarea></td>
		</tr>
		<tr>
		<td>Kota </td>
		<td><input name="kota_ktp"  value="<?=$x->kota_ktp;?>" type="text" onkeypress="return huruf(event)" ></td>
		</tr>
		<tr>
		<td>Kode Pos </td>
		<td><input name="kodepos_ktp"  value="<?=$x->kodepos_ktp;?>" onkeypress="return hanyaAngka(event)" maxlength="5" type="text"></td>
		</tr>
		
		<tr>
		<td>Lama Tinggal </td>
		<td><input name="tinggal_ktp"   value="<?=$x->tinggal_ktp;?>" style="width:50px;" maxlength="3" type="text" onkeypress="return hanyaAngka(event)" > Tahun</td>
		</tr>
		
		<tr>
		<td>E-mail </td>
		<td><input name="email"   value="<?=$x->email;?>" type="text"></td>
		</tr>
		...
		<input name="kendaraan" type="radio" value='kendaraan umun'  <? if($x->kendaraan=='kendaraan umum'){echo 'checked';}?> >kendaraan umum
		</td></tr>
		
		<tr><td>Tanggal aktif </td>
			<td><input name="tgl_aktif"  value="<?=$x->tgl_aktif;?>" type="date"></td>
		</tr>
		
		<tr><td>Tanggal Non Aktif </td>
			<td><input name="tgl_nonaktif" value="<?=$x->tgl_nonaktif;?>"  type="date"></td>
		</tr>
</table>
<p></p>
...
<table align= "left">		
		<tr><td>Nama</td>
			<td><input name="nama" type="text"  value="<?=$x->nama;?>"  onkeypress="return huruf(event)"></td>
		</tr>
		<tr>
			<td>No HP</td>
			<td><input name="no_hp" type="text"  value="<?=$x->no_hp;?>"  maxlength="13" onkeypress="return hanyaAngka(event)" ></td>
		</tr>
</table>
	<table align="center">
		<tr>
		...
		<tr><td>Alamat</td>
			<td><textarea name="alamat_emergency" type="text" ><?=$x->alamat_emergency;?></textarea></td>
		</tr>
...
?>
		...
		<tr><td>
		<select name="ket">
		<option <?php if( $x->ket=='2'){echo "selected"; } ?>  class="required" required value='2'>approve</option>
		<option <?php if( $x->ket=='5'){echo "selected"; } ?>  value='5'>cancel</option>
		</select>
		</td></tr>
		</table>
