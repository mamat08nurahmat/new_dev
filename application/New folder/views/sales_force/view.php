...
?>	
		...
		<table align ="left">
		<tr><td>Posisi</td>
		<td><input value="<?=$x->posisi;?>" name="posisi" type="text" disabled>
		</td></tr>		
		<tr><td>Agency</td>
		<td><input value="<?=$x->AgencyName;?>" name="AgencyName" type="text" disabled>
		</td>
		</tr>
		
		<tr><td>Sales Center</td>
		<td><input value="<?=$x->SalesCenterName;?>" name="SalesCenterName" type="text" disabled>
		</td></tr>
	</table>
