...
<?php foreach($query_list as $datas){?>				

<?php
// if ($datas->UserType='UserType.DS') {
//   # code...
// } else {
//   # code...
// }
...
?>
                      ...
                      <tr>
						...
						<div class="btn-group">	
						<a href="<?=site_url('agency/update/'.$datas->AgencyID.'')?>" >
						<button type="button" class="btn btn-primary">UPDATE</button>
						</a>		
						
            <a href="<?=site_url('agency/view/'.$datas->AgencyID.'')?>" >
            <button type="button" class="btn btn-primary">VIEW</button>
            </a>    

<!---
						<a href="<?=site_url('agency/view')?>" >
