...
class Systemccos extends CI_Controller
{
    ...
    public function by_batch($BatchID)
    {
    	// print_r("expression");die();
        // $systemccos = $this->Systemccos_model->get_all();
        $systemccos = $this->db->query("SELECT * FROM SystemCCOS WHERE BatchID='$BatchID' ORDER BY RowID ASC")->result();
    ...
    public function by_month_year($month,$year)
    {
    	// print_r("expression");die();
        // $systemccos = $this->Systemccos_model->get_all();
        $systemccos = $this->db->query("SELECT * FROM SystemCCOS WHERE ProcessMonth='$month' AND ProcessYear='$year' ORDER BY RowID ASC")->result();
...
/* Generated by Harviacode Codeigniter CRUD Generator 2018-05-02 04:16:54 */
/* http://harviacode.com */