...
class Employee extends CI_Controller
{
	...
	foreach ($this->Employee_model->get_all() as $data) {
	    ...
	    xlsWriteLabel($tablebody, $kolombody++, $data->IsDiscontinued);
	    xlsWriteLabel($tablebody, $kolombody++, $data->IsDedicated);
...
/* Generated by Harviacode Codeigniter CRUD Generator 2018-04-28 23:42:09 */
/* http://harviacode.com */