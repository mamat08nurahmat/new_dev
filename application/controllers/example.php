...
class Example extends CI_Controller {
    ...
    public function index() {
        ...
        if ($this->aauth->login('mat@gmail.com', '12345'))
            echo 'is login';
        else
            echo 'hyr';
    ...
    function create_user() {
        ...
        $a = $this->aauth->create_user("nurahmat@admin.com", "55555", "Admin");
/**/
        if ($a)
            echo "OK   ";
        else
    ...
    function update_user() {
        $a = $this->aauth->update_user(2, "mat@gmail.com", "12345", "tested");
