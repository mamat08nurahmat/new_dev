...
class Systemccos_model extends CI_Model
{

    public $table = 'systemccos';
    public $id = 'RowID';
    public $order = 'DESC';
	...
	$this->db->or_like('DecisionDate', $q);
...
/* End of file Systemccos_model.php */
/* Location: ./application/models/Systemccos_model.php */
