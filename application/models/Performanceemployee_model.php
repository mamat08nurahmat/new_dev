...
class Performanceemployee_model extends CI_Model
{

    public $table = 'performanceemployee';
    public $id = 'RowID';
    public $order = 'DESC';
...
/* End of file Performanceemployee_model.php */
/* Location: ./application/models/Performanceemployee_model.php */
