...
if ($datas->atasan == NULL || $datas->sales_code == NULL  ) {
  # code...
$tombol ="";
$tombol .="
        <a class='btn btn-mini' href=' ".site_url('mapping/update_atasan_code/'.$datas->id.'/'.$datas->no_ktp.'/')."'>
        <button type='button' class='btn btn-danger'>MAPPING CODE DAN ATASAN</button></a>";  
...
$tombol .="
<a class='btn btn-mini' href=' ".site_url('mapping/mapping/'.$datas->id.'/'.$datas->no_ktp.'/')."'>
