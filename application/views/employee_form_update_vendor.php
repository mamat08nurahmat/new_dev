<!-- Main content -->
	    ...
	    <tr><td>HiringLevel <?php echo form_error('HiringLevel') ?></td>
            <td><input type="hidden" class="form-control" name="HiringLevel" id="HiringLevel" placeholder="HiringLevel" value="<?php echo $HiringLevel; ?>" />
        </td>
	    <tr><td>HiringStatus <?php echo form_error('HiringStatus') ?></td>
            <td><input type="hidden" class="form-control" name="HiringStatus" id="HiringStatus" placeholder="HiringStatus" value="<?php echo $HiringStatus; ?>" />
        </td>
