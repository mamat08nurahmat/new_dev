...
// load_data();
        ...
        $.ajax({
            url:"<?php echo site_url('upload/load_data_upload_list'); ?>"+'/'+bulan_proses.value+'/'+tahun_proses.value+'/'+jenis_aplikasi.value,
            method:"POST",
...
///=============
        ...
        $.ajax({
            url:"<?php echo site_url('upload/upload_file_csv'); ?>",
            method:"POST",
...
//         console.log(batchid);
    ...
    if(confirm('Approve data?'))
    {
        ...
        $.ajax({
           ...
           url : "<?php echo site_url('upload/ajax_tes')?>/"+batchid,
