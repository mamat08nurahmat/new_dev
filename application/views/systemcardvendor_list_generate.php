            ...
            <div class='col-xs-12'>
              <div class='box'>
                <div class='box-header'>
                  <h3 class='box-title'>SYSTEMCARDVENDOR LIST <br>	
...
?>                    	
<br>
                  	<!-- <?php echo anchor('systemcardvendor/create/','Create',array('class'=>'btn btn-danger btn-sm'));?> -->
		<?php echo anchor(site_url('systemcardvendor/excel_cardvendor/'.$this->uri->segment(3).'/'), ' <i class="fa fa-file-excel-o"></i> Excel', 'class="btn btn-primary btn-sm"'); ?>
