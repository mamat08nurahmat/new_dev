<!-- Main content -->
	    ...
	    <tr>
		<td>UserGroupID <?php echo form_error('UserGroupID') ?></td>
        <td>
<!--combobox
...
?>
<option value="<?=$user_group->UserGroupID?>"><?=$user_group->UserGroupName." - ".substr($user_group->UserType,9)?></option>
...
?>
	    ...
	    <tr><td>EmailAddress <?php echo form_error('EmailAddress') ?></td>
            <td><input type="email" class="form-control" name="EmailAddress" id="EmailAddress" placeholder="EmailAddress" value="<?php echo $EmailAddress; ?>" />
        </td>
	    ...
	    <tr><td>ExpireDate <?php echo form_error('ExpireDate') ?></td>
            <td><input type="date" class="form-control" name="ExpireDate" id="ExpireDate" placeholder="ExpireDate" value="<?php echo $ExpireDate; ?>" />
        </td>
