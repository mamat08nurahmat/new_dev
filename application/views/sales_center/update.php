...
<input type="text" class="form-control" name="SalesCenterCode" value="<?=$datas->SalesCenterCode;?>" readonly>    
  ...
  <div class="form-group col-md-6">
    ...
    <textarea class="form-control" id="jalan" name="jalan"  rows="3"><?=$datas->StreetAddress;?></textarea>
  	</div> 
    </div>
    ...
    <input type="text" class="form-control" id="no_telpon" name="no_telpon" value="<?=$datas->PhoneNumber;?>">   
        </div>

        <div class="form-group col-md-3">
      <label for="email">Email</label>
    <input type="email" class="form-control" id="email" name="email" value="<?=$datas->EmailAddress;?>">   
        </div>


        <div class="form-group col-md-2">
      <label for="no_fax">Nomer Fax</label>
    <input type="text" class="form-control" id="no_fax" name="no_fax" value="<?=$datas->FaxNumber;?>">   
        </div>
<!----
        <div class="form-group col-md-2">
...
<!-----
  <div class="form-row">
    ...
    <input type="text" class="form-control" id="kelurahan" name="kelurahan" value="<?=$datas->VillageAddress;?>">   
    </div>

    <div class="form-group col-md-4">
      <label for="kecamatan">Kecamatan</label>
    <input type="text" class="form-control" id="kecamatan" name="kecamatan" value="<?=$datas->SubDistrictAddress;?>">   
    </div>

    <div class="form-group col-md-4">
      <label for="kode_pos">Kode Pos</label>
    <input type="text" class="form-control" id="kode_pos" name="kode_pos" value="<?=$datas->PostalCode;?>">   
    </div>
